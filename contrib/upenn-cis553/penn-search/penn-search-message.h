...
class PennSearchMessage : public Header
{
  ...
  public:
    ...
    // m2
    InvertedMsg GetInvertedMessage();

    void SetInvertedMessage(std::string invertedMessage,  std::vector<std::string> keywords, std::set<std::string> docIDs,
